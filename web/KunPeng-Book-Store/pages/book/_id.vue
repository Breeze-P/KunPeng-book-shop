    ...
    <main>
      <div class="container">
        ...
        <div class="grid product">
          ...
          <div class="column-xs-12 column-md-5">
            ...
            <v-rating
              ...
              readonly
              size="19"
              :value="GET_BOOK.score"
            ></v-rating>
            <div class="description">
              <p>{{ GET_BOOK.description }}</p>
            </div>
            <!-- 购买 -->
            <button class="add-to-cart" @click="SubmitBuy">Access in Cart</button>
          </div>
        </div>
        <div class="related-products">
          ...
          <!-- randomKey &&  -->
          <v-row>
            <v-col v-if="GET_PRODUCTS_R" v-for="(item, i) in GET_PRODUCTS_R" :key="i" sm="12" md="4" xl="4" cols="12">
...
export default {
    ...
    methods: {
        ...mapActions("Products", ["GetBook"]),
        ...mapActions("Profile", ["QueryCartTrack", "AddCartTrack"]),
        suggestionItem() {
            for (let i = 0; i < 3; i++) {
    ...
    computed: {
        ...mapGetters("Products", ["GET_BOOK", "GET_PRODUCTS_R"]),
    ...
    mounted() {
        ...
        console.log("book:", this.GET_BOOK);
        console.log("bookInfos:", this.GET_PRODUCTS_R);
        this.suggestionItem();
    },
    components: { Comments }
}
